        ...
        <header>
            <div class="header-nav">
                <ul class="nav-lef">
                    ...
                    <li class="flex-center"><a :style="{color: clickTab===2?'#4285f4':'#333'}" @click="follow">关注</a></li>
                </ul>
                <ul class="nav-right">
                    <li class="flex-center write"><a @click="write">写文章</a></li>
                    <li class="flex-center search"><a href="#">搜索</a></li>
                    <li v-if="isLogin" class="flex-center person"><a @click="toInfo">信息</a></li>
    ...
    export default {
        ...
        methods:{
            follow(){
                ...
                this.clickTab=2;this.$router.push({name:'follow'})
            },
            toInfo(){
                this.$router.push({name: this.isLogin?'person':'sign'})
            },
            write(){
